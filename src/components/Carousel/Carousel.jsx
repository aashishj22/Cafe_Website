...
<div className="carousel-container">
    <div className="control-btns">
        <button className="btn-1" onClick={handleClickPrev} id="prev"><img src={prevBtn}></img></button>
        <button className="btn-1" onClick={handleClickNext} id="next"><img src={nextBtn}></img></button>
    </div>
