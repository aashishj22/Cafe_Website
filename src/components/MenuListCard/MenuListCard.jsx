...
export const MenuListCard = ({setMyCartData ,name, flag, price, width , count, height, border, height2}) => {
  // console.log(border);
  ...
  return (
    <div
      className={`container-item-1 ${(height2 && width<500) ? "height200 justify-spaceEvenly" : ""} ${(height2 && width>500) && "height150"} ${width>500 ? "noBorder" : ""}`}
